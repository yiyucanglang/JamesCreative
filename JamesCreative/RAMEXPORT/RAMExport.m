...
#import <mach-o/ldsyms.h>
 ...
 char * ksssssservicename_service  __attribute((used, section("__DATA,BeehiveMods "))) = "sssssss";
...
NSObject * RAMGetString(NSString *key) {
    ...
    #ifndef __LP64__
        uintptr_t *memory = (uintptr_t*)getsectiondata(mach_header, SEG_DATA, section, &size);
    #else
        const struct mach_header_64 *mhp64 = (const struct mach_header_64 *)mach_header;
        uintptr_t *memory = (uintptr_t*)getsectiondata(mhp64, SEG_DATA, "BeehiveMods", &size);
    #endif
